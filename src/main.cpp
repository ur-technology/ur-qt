...
int main(int argc, char *argv[])
{
    ...
    QSplashScreen *splash = new QSplashScreen(QPixmap(":/images/splash"));
    splash->show();
    QThread::msleep(1500);
    splash->deleteLater();
    QCoreApplication::setOrganizationName("UR-Qt");
    QCoreApplication::setOrganizationDomain("ur.tech");
    QCoreApplication::setApplicationName("UR-Qt");
    QCoreApplication::setApplicationVersion("1.0.0");
    app.setWindowIcon(QIcon(QPixmap(":/images/icon")));

    QTranslator translator;
    translator.load("i18n/ur-qt_" + QLocale::system().name());
